...
| 3 | `out/03-liga.png` | LIGA · Cinco semanas. Una noche por semana. + la escalera A/B/C |
...
| 6 | `out/06-lo-que-ves.png` | Tu sitio. Tu distancia. Tu historial. — "Todo partido cuenta para el rating." |
...
- Frame 6 — the "who is best / how far off / who you beat" card from
  `Groups / Empty Groups page`.

Two things to know about them:

- **They are empty-state screens.** The table is labelled `EXAMPLE` in the
  product, and that label is visible in frame 4. There is no populated league
  table, ladder, or seeded bracket anywhere in Drive — if you want frames 4 and
  6 to show real data, those captures need to be taken.
